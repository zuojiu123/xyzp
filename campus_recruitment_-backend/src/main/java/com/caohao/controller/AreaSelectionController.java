...
public class AreaSelectionController extends SuperController {
     ...
     */
    @GetMapping("/list")
    public Result getAreaList(@RequestParam(value = "parentCode", required = false) String parentCode,
                             @RequestParam(value = "level", required = false) String level) {
        return areaSelectionService.queryArea();
    }
    ...
    public Result getHotCities() {
        return success(this.areaSelectionService.getHotCities());
    }
