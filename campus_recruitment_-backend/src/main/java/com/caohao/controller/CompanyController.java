...
public class CompanyController extends SuperController {
    ...
    public Result queryByPage(@RequestBody CompanyParam company,
        ...
        System.out.println("公司筛选参数: " + company.toString());
    ...
    @ApiOperation("审核公司")
    @PutMapping("/audit")
    public Result auditCompany(@RequestBody CompanyParam company) {
        return success(this.companyService.auditCompany(company));
    }
